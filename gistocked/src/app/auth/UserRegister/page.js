  ...
  return (
    <main className="h-screen grid lg:grid-cols-6 2xl:grid-cols-6 lg:grid-rows-6 2xl:grid-rows-8 lg:gap bg-Colores_Login-1">
        <form className="py-8 lg:col-[3/5] 2xl:col-[3/5] lg:row-[2/6] 2xl:row-[2/8] font-racing_sans_one rounded-lg bg-Colores_Login-2">
            <ul className="grid grid-cols-1 grid-rows-7 lg:gap-4 2xl:gap-4">
              <li>
              ...
              <li>
                <div className="lg:mx-14 lg:h-10 2xl:h-20 text-black rounded-md bg-Colores_Login-3">
                  <Link href="#" className="w-full">
                    <div>
                      <Image alt="Logo de Google" src="/images/Logo-Google.png" width={80} height={55} className="inline 2xl:w-40"></Image>
                      <p className="inline lg:text-md 2xl:text-xl">Registrase Con Google</p>
                    </div>
                  </Link>
                </div>
              </li>
              ...
              <li>
                <div className="mx-14 lg:h-10 2xl:h-20 text-black rounded-md">
                  <input type="email" placeholder="Correo" className="px-5 w-full h-full lg:text-md 2xl:text-xl rounded-md bg-Colores_Login-3"></input>
                </div>
              </li>

              <li>
                <div className="mx-14 lg:h-10 2xl:h-20 text-black rounded-md">
                  <input type="password" placeholder="Contraseña" className="px-5 w-full h-full lg:text-md 2xl:text-xl rounded-md bg-Colores_Login-3"></input>
                </div>
              </li>

              <li>
                <div className="mx-14 lg:h-10 2xl:h-20 text-black grid place-items-center rounded-md bg-Colores_Login-3">
                  <button type="submit" className="lg:text-md 2xl:text-xl">Registrase</button>
                </div>
              </li>
            </ul>
        </form>
