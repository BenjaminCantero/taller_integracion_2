...
export default function Home() {
  return (
    <main className="grid grid-cols-3 grid-rows-5 gap-3">
        <form className="col-start-2 col-end-3 row-start-2 row-end-5 font-racing_sans_one rounded-lg bg-Colores_Login-2">
