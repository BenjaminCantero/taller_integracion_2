...
const Sidebar = ({ children, usuarioInfo, setPagina }) => {
  ...
  return (
    <div className="flex">
      {/* SideBar */}
      <section className="fixed top-0 left-0 h-screen w-64 flex flex-col justify-between text-white bg-gray-800 overflow-y-auto">
        {/* Logo de la Empresa */}
      ...
      {/* Children */}
      <section className="grow ml-64 w-full bg-gray-100 overflow-y-auto">
        {children}
      </section>
    </div>
  );
