...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <header className="bg-gray-900 text-white shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center p-4">
          ...
          <nav className="hidden md:flex space-x-6">
            <Link href="/" className="hover:text-gray-400 transition-colors focus:outline-none">
              Inicio
            </Link>
            <Link href="/products" className="hover:text-gray-400 transition-colors focus:outline-none">
              Productos
            </Link>
            <Link href="/sales" className="hover:text-gray-400 transition-colors focus:outline-none">
              Ventas
            </Link>
            <Link href="/inventory" className="hover:text-gray-400 transition-colors focus:outline-none">
              Inventario
            </Link>
          </nav>
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white shadow-lg mt-8">
